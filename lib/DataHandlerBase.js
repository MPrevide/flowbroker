...
module.exports = class DataHandlerBase {
     ...
     * @param  {string} locale Locale string, such as "en-US", "pt-BR"
     * @param {string} defaultLocale If the locale is not found, if nothing is pass the use "en-US",
     * @return {object}        Locale settings used by the module
     */
    getLocaleData(locale, defaultLocale = 'en-US') {

        console.log('__dirname', __dirname);
        console.log('getLocalesPath', this.getLocalesPath());
...
/*        const html = fs.readFileSync(path);
        ...
        let filepath2 = path.join(this.getLocalesPath(),  locale , this.getLocaleFilename());
        let filepath = this.getLocalesPath() + '/' +  locale  + '/'+  this.getLocaleFilename();
        console.log('path1 join', filepath2);
        console.log('path1 sem', filepath);
